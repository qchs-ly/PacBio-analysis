...
csv_file1 = '04_MCF7_uniqueAA.csv'
csv_file2 = '04_MCF10A_uniqueAA.csv'
output_overlapping_file = '07_overlapping.csv'
output_non_overlapping_file = '07_non_overlapping.csv'
